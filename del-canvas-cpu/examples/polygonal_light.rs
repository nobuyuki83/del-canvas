...
fn radiance(ray: &Ray, vtx2xyz: &[f64], _rng: &mut rand::rngs::ThreadRng) -> Vector {
...
fn main() {
    ...
    let cam = del_canvas_core::cam3::Camera3::new(
        1024,
        768,
    ...
    }
    {
        ...
        let file = std::fs::File::create("target/02_img.hdr").unwrap();
