...
) -> anyhow::Result<()>
{
    ...
    let count_splat_in_tile = crate::get_or_load_func(
        ...
        del_canvas_cuda_kernel::SPLAT_GAUSS)?;
    ...
    cudarc::driver::CudaSlice<u32>)>
{
    ...
    let (tile2idx_dev, pnt2ind_dev) = {
        ...
        let count_splat_in_tile =
            crate::get_or_load_func(&dev, "count_splat_in_tile", del_canvas_cuda_kernel::SPLAT_GAUSS)?;
        unsafe { count_splat_in_tile.launch(cfg, param) }?;
    ...
    let idx2pnt_dev = {
        ...
        use cudarc::driver::LaunchAsync;
        let count_splat_in_tile =
            crate::get_or_load_func(&dev, "fill_index_info", del_canvas_cuda_kernel::SPLAT_GAUSS)?;
        unsafe { count_splat_in_tile.launch(cfg, param) }?;
